...
| Reading Assessment (paper edition) | 04 Mar   |
...
| 26 Feb | No Class                                                               |                                                                                                                                                                              |
+--------+------------------------------------------------------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| 05 Mar | lavaan and Maximum Likelihood Estimation with Missing Data (Chapter 3) | -   [Slides (PDF)](https://jonathantemplin.github.io/MissingDataMethods2025/_lectures/04_lavaan_and_Missing_Data_Using_MLEs/04_lavaan_and_Missing_Data_Using_MLE_S2025.pdf)  |
|        |                                                                        | -   [R files](https://github.com/jonathantemplin/MissingDataMethods2025/tree/main/_lectures/04_lavaan_and_Missing_Data_Using_MLEs)                                           |
...
|----|----|----|----|
| 8 | 12 Mar | Bayesian Estimation with Missing Data | Chapter 5 |
| 9 | 19 Mar | Spring Break: No Class | No Readings |
| 10 | 26 Mar | Bayesian Estimation for Categorical Variables | Chapter 6 |
| 11 | 2 Apr | Multiple Imputation | Chapter 7 |
| 12 | 9 Apr | Multilevel Missing Data | Chapter 8 |
| 13 | 16 Apr | Missing Not at Random Processes | Chapter 9 |
