...
| Assignment                      | Due Date |
|---------------------------------|----------|
| Homework #2 (Available in ICON) | 28 Feb   |
...
+---------+------------------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| 19 Feb  | MLE with Missing Data (and lavaan) | -   [Slides (PDF)](https://jonathantemplin.github.io/MissingDataMethods2025/_lectures/04_lavaan_and_Missing_Data_Using_MLEs/04_lavaan_and_Missing_Data_Using_MLEs_S2025.pdf) |
