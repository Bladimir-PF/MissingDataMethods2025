...
+------------+------------------------------------------------------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| 26 Mar     | Bayesian Estimation with Missing Data                                  | -   [Slides (pdf)](https://jonathantemplin.github.io/MissingDataMethods2025/_lectures/07_Missing_Data_with_Bayeisan/07_Bayesian_with_Missing_data.html)                      |
...
+==========+==========+===============================================+==================+
| 11       | 2 Apr    | Bayesian Estimation with Missing Data         | Chapter 5        |
+----------+----------+-----------------------------------------------+------------------+
| 12       | 9 Apr    | Bayesian Estimation for Categorical Variables | Chapter 6        |
+----------+----------+-----------------------------------------------+------------------+
| 13       | 16 Apr   | Multiple Imputation                           | Chapter 7        |
+----------+----------+-----------------------------------------------+------------------+
| 14       | 23 Apr   | Multilevel Missing Data                       | Chapter 8        |
+----------+----------+-----------------------------------------------+------------------+
| 15       | 30 Apr   | No Class: AERA/NCME Conference                |                  |
+----------+----------+-----------------------------------------------+------------------+
| 16       | 7 May    | Missing Not at Random Processes               | Chapter 9        |
+----------+----------+-----------------------------------------------+------------------+
